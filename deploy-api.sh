...
echo ""
MCP_INVOKE_POLICY="$(query_output McpServerInvokePolicyArn)"

echo "  MCP server config (claude_desktop_config.json / .cursor/mcp.json):"
echo "  The MCP server calls Lambda directly via IAM — no API Gateway URL needed."
echo "    {"
echo "      \"mcpServers\": {"
echo "        \"screenweave\": {"
echo "          \"command\": \"node\","
...
echo "            \"START_CRAWL_FUNCTION\": \"screenweave-start-crawl-${ENV}\","
echo "            \"GET_SESSION_FUNCTION\": \"screenweave-get-session-${ENV}\""
echo "          }"
echo "        }"
echo "      }"
echo "    }"
echo ""
echo "  Attach this IAM policy to the principal running the MCP server:"
echo "    ${MCP_INVOKE_POLICY}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
